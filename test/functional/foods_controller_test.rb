...
class FoodsControllerTest < ActionController::TestCase
  ...
  test "should create food" do
    assert_difference('Food.count') do
      post :create, food: { desc: @food.desc, img_url: @food.img_url, name: @food.name, price: @food.price }
    end
  ...
  test "should update food" do
    put :update, id: @food, food: { desc: @food.desc, img_url: @food.img_url, name: @food.name, price: @food.price }
    assert_redirected_to food_path(assigns(:food))
  end
